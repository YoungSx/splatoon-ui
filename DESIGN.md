...
`SegmentedControl` covers one-of-many selection with radio semantics. It can use ButtonGroup-like connected buttons or Switch-like track styling, but it must not expand `Switch` beyond boolean on/off.
