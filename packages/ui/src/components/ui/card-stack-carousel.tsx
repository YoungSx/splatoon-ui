  ...
  return (
    <CardStackCarouselPhysicsContext.Provider value={store}>
      <div
        ...
        data-support-position={(sceneSnapshot.support.pitchPx > 0
          ? sceneSnapshot.support.positionPx / sceneSnapshot.support.pitchPx
          : 0
        ).toFixed(4)}
        data-support-velocity={(sceneSnapshot.support.pitchPx > 0
          ? sceneSnapshot.support.velocityPxPerSecond / sceneSnapshot.support.pitchPx
          : 0
        ).toFixed(4)}
      >
        {children}
...
export function CardStackCarouselItem({
  ...
  const isVisible =
    Math.abs(continuousOffset) <=
    cardStackLayout.visibleOffsetLimit + cardStackLayout.visibleOffsetBuffer
  ...
  return (
    ...
    >
      <motion.div
        ...
        className={cn(
          'pointer-events-auto w-full origin-center transition-colors duration-300',
          className
        )}
