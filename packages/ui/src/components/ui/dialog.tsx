  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          'shadow-soft-splat-lg fixed top-1/2 left-1/2 flex max-h-[calc(100dvh-2rem)] w-full max-w-[calc(100%-3.5rem)] flex-col outline-none data-open:animate-[dialog-pop-in_var(--dialog-pop-in-duration,0.5s)_var(--ease-back-out)_both] sm:max-w-md',
          isReducedMotion
...
function DialogTitle({ className, style, ...props }: DialogTitleProps) {
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn('splat-skew text-2xl font-black tracking-wider text-current', className)}
