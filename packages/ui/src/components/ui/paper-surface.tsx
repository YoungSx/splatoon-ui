    ...
    <div ref={ref} className={cn('relative flex flex-col', className)} {...props}>
      {showTopEdge ? (
        <PaperTearEdge
          ...
          color={fill}
          className={cn(
            'pointer-events-none relative z-10 mb-[-2px] select-none',
            topEdgeClassName
          )}
        />
      ) : null}
       ...
       */}
      <div className={cn('relative z-10', contentClassName, 'w-full min-w-0 overflow-x-clip')}>
        {children}
      </div>
      {showBottomEdge ? (
        <PaperTearEdge
          ...
          color={fill}
          className={cn(
            'pointer-events-none relative z-10 mt-[-2px] select-none',
            bottomEdgeClassName
          )}
        />
      ) : null}
